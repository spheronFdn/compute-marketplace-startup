...
sed -i "s/feeder: \".*\"/feeder: \"$FEEDER_WALLET_ADDRESS\"/" config.yaml
sed -i "s/feederMnemonic: \".*\"/feederMnemonic: \"$FEEDER_WALLET_MNEMONIC\"/" config.yaml
sed -i "s/validator: \".*\"/validator: \"$FEEDER_VALIDATOR\"/" config.yaml
