...
sed -i -e "s|^minimum-gas-prices *=.*|minimum-gas-prices = \"0.025uart\"|" /home/artela/.artelad/config/app.toml
...
sed -i \
  ...
  /home/artela/.artelad/config/app.toml
...
sed -i -e "s%^proxy_app = \"tcp://127.0.0.1:26658\"%proxy_app = \"tcp://127.0.0.1:23458\"%; \
          ...
          s%^prometheus_listen_addr = \":26660\"%prometheus_listen_addr = \":23466\"%" /home/artela/.artelad/config/config.toml
...
sed -i -e "s%^address = \"tcp://0.0.0.0:1317\"%address = \"tcp://0.0.0.0:23417\"%; \
          ...
          s%:8545%:23445%; \
          s%:8546%:23446%; \
          s%:6065%:23465%" /home/artela/.artelad/config/app.toml
