...
wget -O config.toml https://raw.githubusercontent.com/filecoin-project/lotus/master/documentation/en/default-lotus-config.toml
...
FULLNODE_API_INFO=wss://wss.mainnet.node.glif.io/apigw/lotus lotus daemon --lite --config config.toml
